...
const creepBodyShape = struct({
	 ...
	 * boosting. One of the `RESOURCE_*` constants. [Learn
	 * more](https://docs.screeps.com/resources.html)
	 * @public
	 */
...
export const creepShape = declare('Creep', () => struct(...structForPath<CreepSchema>()('Creep', roomObjectShape, {
	...variant('creep'),
	/**
	 * An array describing the creep's body. [Learn more](https://docs.screeps.com/resources.html).
	 * @public
	 * @see https://docs.screeps.com/api/#Creep.body
	 */
	body: vector(creepBodyShape),
